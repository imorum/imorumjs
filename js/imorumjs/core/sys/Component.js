...
$s.registerClass('infrajs.Component', infrajs.events.EventDispatcher, infrajs.IDisposable);

$create = $s.create = function create(type, properties, events, element) {
...
$s._register = function _register(component, dontUpdate) {
    var ret = false;
...
$s._setProperties = function _setProperties(target, properties) {
    var current;
